                    ...
                    <div class="container">
                        <form method="POST" action="addartist.php" enctype="multipart/form-data">
                            ...
                            <div class="row form-group" style="margin-bottom:0.8rem;">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name = "artistNationality" list="artistNationalities">
                                    <datalist id="artistNationalities">
                                        <?php
                                            $sql = 'SELECT DISTINCT artistNationality FROM artisttable';
                                                foreach ($db->query($sql) as $row){
                                                ?>
                                                <option value="<?php echo $row['artistNationality'];?>">
                                            <?php 
                                            }
                                        ?>
                                    </datalist>
